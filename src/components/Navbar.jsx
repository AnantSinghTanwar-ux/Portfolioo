        ...
        <div className="md:hidden bg-glass border-b border-white/5 px-6 py-4 flex flex-col gap-5">
          {navLinks.map((link) => (
            <a
              ...
              className="nav-link text-sm relative after:absolute after:left-0 after:bottom-0 after:h-[2px] after:w-0 after:bg-purple-400 after:transition-all hover:after:w-full hover:text-white transition-colors duration-300"
            >
              {link.label}
            </a>
          ))}
